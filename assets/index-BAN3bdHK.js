const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Welcome-DbKC71dt.js","./marked.esm-DKjyhwJX.js","./Welcome-Ba3syqy_.css","./PythonYieldFrom-FAZj-HF6.js","./PythonYieldFrom-C0zAW_DX.css","./NotFound-CNyK8g0P.js","./NotFound-DF9nnz9Q.css"])))=>i.map(i=>d[i]);
...
<slot name="end"></slot>
`;class _p extends Z({style:$p,template:Sp,props:kp}){}_p.define(Ep);const Cp="s-appbar",Tp=`
:host{
  display: flex;
  align-items: center;
  position: relative;
...
<slot name="end"></slot>
`;class Rp extends Z({style:Tp,template:Ap,setup(t){const n=t.querySelector(".view");ho.CSSContainer||new ResizeObserver(()=>{n.classList.toggle("s-laptop",this.offsetWidth<=1024),n.classList.toggle("s-tablet",this.offsetWidth<=768)}).observe(this)}}){}Rp.define(Cp);const Op="s-avatar",Mp=ae({$src:""}),Np=`
:host{
  display: inline-flex;
...
`;class Pp extends Z({style:Np,template:Lp,props:Mp,setup(t){const n=document.createElement("img");return{src:r=>{n.src=r,n.onload=()=>{this.dispatchEvent(new Event("load")),t.insertBefore(n,t.children[0])},n.onerror=()=>{this.dispatchEvent(new ErrorEvent("error")),n.isConnected&&t.removeChild(n)}}}}}){}Pp.define(Op);const Fp="s-badge",Dp=`
:host{
  display: inline-flex;
  justify-content: center;
  align-items: center;
...
`;class Bp extends Z({style:Dp,template:Ip}){}Bp.define(Fp);const _t=e=>{const t=e.trim().match(/^([\d\.]+)(s|ms)$/);if(!t)throw new Error;const n=Number(t[1]);return t[2]==="s"?n*1e3:n},qp="s-bottom-sheet",zp=ae({showed:!1,disabledGesture:!1}),Hp=go({show:CustomEvent,showed:Event,close:CustomEvent,closed:Event}),Up=`
:host{
...
`;class eh extends Z({style:Jp,template:Qp,props:Yp}){}eh.define(Xp);const th="s-card",nh=ae({type:["elevated","filled","outlined"],clickable:!1}),rh=`
:host{
  display: inline-block;
  vertical-align: middle;
  border-radius: 12px;
...
`,fh="<slot></slot>";class Kl extends Z({style:uh,template:fh,props:dh,setup(){return{selected:()=>{this.parentNode instanceof Zl&&this.dispatchEvent(new Event(`${Zr}:update`,{bubbles:!0}))}}}}){}Zl.define(Zr);Kl.define(ch);const ph="s-checkbox",hh=ae({disabled:!1,checked:!1,indeterminate:!1}),gh=`
:host{
  display: inline-flex;
  align-items: center;
  vertical-align: middle;
...
<slot></slot>
<s-ripple class="ripple" attached="true" part="ripple"></s-ripple>
`;class bh extends Z({style:gh,template:mh,props:hh,setup(){this.addEventListener("click",()=>{this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked,this.dispatchEvent(new Event("change"))})}}){}bh.define(ph);const vh="s-chip",xh=ae({type:["filled","outlined"],$value:"",checked:!1,disabled:!1,clickable:!1}),yh=`
:host{
  display: inline-flex;
  align-items: center;
  vertical-align: middle;
...
`,st=48,pn=4,hn=(st-pn)*Math.PI,_h=`
...
`;class Ch extends Z({style:Sh,template:_h,props:$h,setup(t){const n=t.querySelector(".known .track"),r=t.querySelector(".known .indicator"),o=()=>{const s=Math.min(this.value,this.max)/this.max*100,i=hn-hn*(s/100),a=s/100*360;n.style.strokeDashoffset=`${s===0?0:Math.min(hn+16-i,hn)}px`,n.setAttribute("transform",`rotate(${a+20}, ${st/2}, ${st/2})`),r.style.strokeDashoffset=`${i}px`};return{max:o,value:o}}}){}Ch.define(kh);const Kr=(e,t="yyyy-MM-dd")=>{typeof e=="string"&&(e=new Date(e));const n=e.getFullYear(),r=e.getMonth()+1,o=e.getDate();return t.replace("yyyy",n.toString()).replace("MM",r.toString().padStart(2,"0")).replace("dd",o.toString().padStart(2,"0"))};class Th{constructor(t){et(this,"list");et(this,"locale",navigator.language);et(this,"updates",new Map);this.list=t}getItem(t){if(t=t||this.locale,t in this.list)return this.list[t];const[n]=t.split("-");return n in this.list?this.list[n]:this.list.zh}addItem(t,n){if(this.list[t])throw new Error(`Locale ${t} already exists`);this.list[t]=n}setLocale(t){this.locale=t??navigator.language,this.updates.forEach(n=>n())}}const Wt=new Th({});Wt.list={zh:{display:e=>`${e.getFullYear()}年${e.getMonth()+1}月${e.getDate()}日 星期${Wt.list.zh.displayWeeks[e.getDay()]}`,displayMonth:e=>`${e.getFullYear()}年`,displayWeeks:["日","一","二","三","四","五","六"]},en:{display:e=>`${["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][e.getDay()]}, Jan ${e.getDate()}`,displayMonth:e=>`${["January","February","March","April","May","June","July","August","September","October","November","December"][e.getMonth()]} ${e.getFullYear()}`,displayWeeks:["S","M","T","W","T","F","S"]}};const Ah="s-date",Rh=ae({$value:"",$locale:"",$max:"2099-12-31",$min:"1900-01-01"}),Oh=`
:host{
  display: inline-block;
  vertical-align: middle;
  border-radius: 8px;
...
`,Nn={years:[],weeks:[],days:[]};for(let e=0;e<200;e++)e<7&&Nn.weeks.push('<div class="item"></div>'),e<31&&Nn.days.push(`<div class="item"><s-ripple class="icon-button">${e+1}</s-ripple></div>`),Nn.years.push('<s-ripple class="button item"></s-ripple>');const Mh=`
...
`,Uh="<slot></slot>";class jh extends Z({style:Hh,template:Uh}){}jh.define(zh);const Wh="s-dialog",Vh=ae({showed:!1,size:["standard","full"]}),Zh=go({show:CustomEvent,showed:Event,close:CustomEvent,closed:Event}),Kh=`
:host{
  display: inline-block;
  vertical-align: middle;
}
...
`,Qh="<slot></slot>";class eg extends Z({style:Jh,template:Qh}){}eg.define(Yh);const tg="s-drawer",ng=`
:host{
  display: flex;
  height: 100%;
  overflow: hidden;
...
<slot></slot>`;class lg extends Z({style:ig,template:ag}){}lg.define(sg);const cg="s-fab",dg=ae({hidden:!1,disabled:!1}),ug=`
:host{
  display: inline-flex;
  vertical-align: middle;
  justify-content: center;
...
`;class pg extends Z({style:ug,template:fg,props:dg}){}pg.define(cg);const hg="s-icon-button",gg=ae({disabled:!1,type:["standard","filled","filled-tonal","outlined"]}),mg=`
:host{
  display: inline-flex;
  vertical-align: middle;
  justify-content: center;
...
<slot></slot>
`;class Mg extends Z({style:Rg,template:Og}){}const Ng="s-menu-item",Xl=ae({checked:!1,folded:!0}),Lg=`
:host{
  display: flex;
  flex-direction: column;
...
`;class Fg extends Z({style:Lg,template:Pg,props:Xl,setup(t){const n=t.querySelector(".container"),r=t.querySelector(".fold"),o=t.querySelector("slot[name=menu]");return r.onclick=s=>s.stopPropagation(),o.onslotchange=()=>n.classList[o.assignedElements().length>0?"add":"remove"]("show-menu"),n.onclick=()=>{n.classList.contains("show-menu")&&(this.folded=!this.folded)},{folded:s=>r.folded=s}}}){}Mg.define(Ag);Fg.define(Ng);const us="s-navigation",Dg=ae({mode:["bottom","rail"],$value:""}),Ig=`
:host{
  display: flex;
  justify-content: center;
  align-items: center;
...
<slot id="slot"></slot>
<slot name="end"></slot>
`;class fs extends Z({style:Ig,template:Bg,props:Dg,setup(t){const n=t.querySelector("#slot"),r=new vr({context:this,class:Yl,slot:n});return{expose:{get options(){return r.list},get selectedIndex(){return r.selectedIndex}},value:{get:()=>r.value,set:o=>r.value=o}}}}){}const qg="s-navigation-item",zg=ae({selected:!1,$value:""}),Hg=`
:host{
  display: flex;
  align-items: center;
  justify-content: center;
...
<slot name="text"></slot>
`;class Yl extends Z({style:Hg,template:Ug,props:zg,setup(){return this.addEventListener("click",()=>{this.selected||this.parentNode instanceof fs&&this.dispatchEvent(new Event(`${us}:select`,{bubbles:!0}))}),{selected:()=>{this.parentNode instanceof fs&&this.dispatchEvent(new Event(`${us}:update`,{bubbles:!0}))}}}}){}fs.define(us);Yl.define(qg);const jg="s-field",Wg=ae({focused:!1,fixed:!0}),Vg=`
:host{
  display: inline-block;
  vertical-align: middle;
  font-size: .875rem;
...
`;class Kg extends Z({style:Vg,template:Zg,props:Wg}){}Kg.define(jg);const Gg="s-fold",Xg=ae({folded:!1}),Yg=`
:host{
  display: block;
}
.container{
...
`;class Qg extends Z({style:Yg,template:Jg,props:Xg,setup(t){t.querySelector("slot[name=trigger]").onclick=()=>this.folded=!this.folded}}){}Qg.define(Gg);const e0="s-page",t0=ae({theme:["light","auto","dark"]}),n0=`
:host{
  display: flow-root;
  height: 100%;
...
`;class Jl extends Z({style:g0,template:m0,props:h0,setup(){return this.addEventListener("click",()=>{this.selected||this.parentNode instanceof gs&&this.dispatchEvent(new Event(`${hs}:select`,{bubbles:!0}))}),{selected:()=>{this.parentNode instanceof gs&&this.dispatchEvent(new Event(`${hs}:update`,{bubbles:!0}))}}}}){}gs.define(hs);Jl.define(p0);const b0="s-popup",v0=ae({align:["center","left","right"]}),x0=go({show:Event,showed:Event,closed:Event}),y0=`
:host{
  display: inline-block;
  vertical-align: middle;
  text-align: left;
...
`;class R0 extends Z({style:T0,template:A0,setup(){this.addEventListener("click",()=>this.dispatchEvent(new Event(`${Ys}:click`,{bubbles:!0})))}}){}Gr.define(Ys);R0.define(C0);const O0="s-radio-button",M0=ae({disabled:!1,checked:!1,name:"",$value:""}),N0=`
:host{
  display: inline-flex;
  vertical-align: middle;
  align-items: center;
...
<slot></slot>
<s-ripple class="ripple" attached="true" part="ripple"></s-ripple>
`;class P0 extends Z({style:N0,template:L0,props:M0,setup(){this.addEventListener("click",()=>{this.checked=!0,this.name&&document.querySelectorAll(`${this.tagName}[name='${this.name}']`).forEach(t=>{t!==this&&(t.checked=!1)}),this.dispatchEvent(new Event("change"))})}}){}P0.define(O0);const F0="s-rate",Gn=ae({readOnly:!1,$max:10,$min:0,$value:5,$step:1}),D0=`
:host{
  display: inline-flex;
  vertical-align: middle;
  overflow: hidden;
...
<input
  ...
  value="${Gn.value}"
/>
`;class B0 extends Z({style:D0,template:I0,props:Gn,setup(t){const n=t.querySelector(".indicator"),r=t.querySelector("input"),o=()=>{const i=(Number(r.value)-this.min)*100/this.max-this.min;n.style.width=`${i}%`};return r.onchange=()=>this.dispatchEvent(new Event("change")),r.oninput=()=>{this.value=Number(r.value),this.dispatchEvent(new Event("input"))},{max:s=>{r.max=String(s),o()},min:s=>{r.min=String(s),o()},step:s=>{r.step=String(s),o()},value:s=>{r.value=String(s),o()}}}}){}B0.define(F0);const q0="s-search",z0=ae({$placeholder:"",disabled:!1,$value:"",$maxLength:-1,readOnly:!1}),H0=`
:host{
  display: inline-flex;
  vertical-align: middle;
  min-height: 40px;
...
<slot name="end"></slot>
<s-ripple attached="true" part="ripple"></s-ripple>
`;class Ql extends Z({style:X0,template:Y0,props:G0,setup(){return this.addEventListener("click",()=>{!(this.parentNode instanceof bs)||this.selected||this.selectable&&this.dispatchEvent(new Event(`${ms}:select`,{bubbles:!0}))}),{selected:()=>{this.parentNode instanceof bs&&this.dispatchEvent(new CustomEvent(`${ms}:update`,{bubbles:!0,detail:{}}))}}}}){}bs.define(ms);Ql.define(K0);const J0="s-skeleton",Q0=`
:host{
  display: block;
  height: 16px;
...
`;class em extends Z({style:Q0}){}em.define(J0);const tm="s-slider",_n=ae({disabled:!1,$labeled:!1,$max:100,$min:0,$step:1,$value:0}),nm=`
:host{
  display: block;
  color: var(--s-color-primary, #006782);
  height: 16px;
...
`;class gm extends Z({style:pm,template:hm,props:fm,setup(){this.addEventListener("click",()=>{this.checked=!this.checked,this.dispatchEvent(new Event("change"))})}}){}gm.define(um);const vs="s-tab",mm=ae({mode:["scrollable","fixed"],$value:""}),bm=`
:host{
  display: flex;
  justify-content: flex-start;
  position: relative;
...
`,Sm=`
<slot></slot>
`;class _m extends Z({style:$m,template:Sm}){}const Cm="s-thead",Tm=`
:host{
...
`,Am="<slot></slot>";class Rm extends Z({style:Tm,template:Am}){}const Om="s-tbody",Mm=`
:host{
...
`,Nm="<slot></slot>";class Lm extends Z({style:Mm,template:Nm}){}const Pm="s-tr",Fm=`
:host{
  display: table-row;
}
`,Dm="<slot></slot>";class Im extends Z({style:Fm,template:Dm}){}const Bm="s-th",qm=`
:host{
  display: table-cell;
  padding: 12px 16px;
  text-transform: capitalize;
}
`,zm="<slot></slot>";class Hm extends Z({style:qm,template:zm}){}const Um="s-td",jm=`
:host{
  display: table-cell;
  user-select: text;
  padding: 12px 16px;
}
`,Wm="<slot></slot>";class Vm extends Z({style:jm,template:Wm}){}_m.define(km);Rm.define(Cm);Lm.define(Om);Im.define(Pm);Hm.define(Bm);Vm.define(Um);const Zm="s-text-field",Km=ae({$label:"",$placeholder:"",disabled:!1,type:["text","number","password","multiline"],error:!1,$value:"",$maxLength:-1,readOnly:!1,multiLine:!1,countered:!1}),Gm=`
:host{
  display: inline-grid;
  vertical-align: middle;
  font-size: .875rem;
